...
import WordEditor from "@/app/components/tools/word-editor/WordEditor";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.forgecodehub.com/tools/word-editor",
    type: "website",
  },
  twitter: {
...
export default function WordEditorPage() {
  return (
    <>
      ...
      >
        <RelatedTools currentPath="/tools/word-editor" category="productivity" />
      </div>
