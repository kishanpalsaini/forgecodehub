...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.forgecodehub.com/tools/online-json-formatter",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    url: "https://www.forgecodehub.com/tools/online-json-formatter",
  },
};
  ...
  return (
    ...
    <>
      ...
      <div className="container" style={{ margin: "0 auto", maxWidth: "1600px", padding: "4rem 1rem" }}>
        <RelatedTools
          currentPath="/tools/online-json-formatter"
          category="dev"
        />
      </div>
