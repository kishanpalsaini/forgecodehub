...
export default function Navbar() {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "#272537", borderBottom: `1px solid ${border}`, padding: "10px 20px", flexShrink: 0 }}>
      ...
      <Link href="/#tools" style={{ display: "inline-flex", alignItems: "center", gap: 5, fontSize: 12, fontWeight: 500, color: "rgb(232, 105, 42)", textDecoration: "none", padding: "6px 8px", borderRadius: 6, whiteSpace: "nowrap", transition: "color 0.15s" }}>
        ← All Tools
      </Link>
    </div>
  );
